    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(postOpPatientFeed.this, android.R.style.Theme_Holo_Light));
                TextView title = new TextView(postOpPatientFeed.this);
                ...
                builder.setPositiveButton("Tag", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        AlertDialog.Builder tagDialog = new AlertDialog.Builder(new ContextThemeWrapper(postOpPatientFeed.this, android.R.style.Theme_Holo_Light));
                        TextView title = new TextView(postOpPatientFeed.this);
                        ...
                        tagDialog.setPositiveButton("Black", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent = new Intent(postOpPatientFeed.this,postOpPatientFeed.class);
...
//            Query query = patients.whereEqualTo("triageTag","Blue");
        Query query = patients.whereLessThan("rHeartRate",50).whereEqualTo("department","Post-Operation");
...
//            Query query = patients.whereEqualTo("triageTag","Blue");
        Query query = patients.whereEqualTo("department","Post-Operation").whereEqualTo("triageTag","Black");
...
//            Query query = patients.whereEqualTo("triageTag","Blue");
        Query query = patients.whereEqualTo("department","Post-Operation").whereEqualTo("triageTag","Red");
...
//            Query query = patients.whereEqualTo("triageTag","Blue");
        Query query = patients.whereEqualTo("department","Post-Operation").whereEqualTo("triageTag","Yellow");
